...
INSERT INTO `mydatabase`.`alarm` (
  `user_id`, `phone`, `birth_date`, `address`, `is_repetition`, `time`, `is_active`, `ai_script`, `memo`, `emergency_phone`, `emergency_count`
) 
VALUES 
  (1, '+821012345678', '1990-01-01', 'Seoul, South Korea', TRUE,'[null,null,null,null,null,null,"19:46"]', TRUE, 'AI Script Example', 'Remember to call in the morning.', '+821012345678', 1),
  (2, '+821012345678', '1985-02-15', 'Busan, South Korea', FALSE, '["19:42",null,null,null,null,null,"19:45"]', FALSE, NULL, 'Important meeting on Monday', NULL, 0),
  (3, '+821012345678', '2000-03-20', '', TRUE, '["19:43",null,null,null,null,null,null]', TRUE, 'AI Script for emergency', NULL, '010-8765-4321', 3);
